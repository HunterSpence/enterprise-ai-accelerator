# Claude Fable 5 Upgrade — v0.4.0 Model Refresh
...
Fable 5 (`claude-fable-5`) is the Anthropic flagship as of June 9, 2026. It replaces Opus 4.7 (`claude-opus-4-7-20250514`) in the coordinator role. Observed improvements relevant to this platform:
...
|-------|-------|--------|-------------|
| Fable 5 | $10 / MTok | $50 / MTok | Higher nominal rate |
| Opus 4.8 | $5 / MTok | $25 / MTok | Lower nominal rate |
| Opus 4.7 (deprecated) | $15 / MTok | $75 / MTok | Was the flagship |

Fable 5 is cheaper than Opus 4.7 at the coordinator tier. The ~95% cost savings vs. always-Opus baseline (documented in v0.2.0) remains valid under the new pricing.
